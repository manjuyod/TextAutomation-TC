...
import Meeting2DataCollectionsGilbertOnly
...
franchise_info = [
    (57, 'Gilbert', 'MST/MDT','https://tutoringclub.com/gilbertaz/student-intake-form/','https://tutoringclub.com/gilbertaz/assessment-payment-form/','3305 E Williams Field Rd #102, Gilbert, AZ 85295')
...
def main():
    ...
    df = Meeting2DataCollectionsGilbertOnly.fetch_meeting_data(engine)
    if df.empty:
