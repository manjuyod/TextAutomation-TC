...
import Meeting2DataCollectionsVegasOnly
...
""" + laptop_message + map_link_message + closing_message_two
            ...
            message_template = f"""
Hi, {guardian_default}. It's Katie from Tutoring Club Clovis, just confirming your visit with us {relative_day}.

We’ll meet at {meeting_time} to go over {student_names}'s academic plan and next steps.""" + laptop_message + """
You can find us at 779 Herndon #105, on the northwest corner of Herndon & Clovis, right next to Starbucks.

Looking forward to seeing you soon! Feel free to text back to confirm or if you have any questions."""
        elif franchise_id == 8:
            message_template = f"""
Hi, {guardian_default}. It's Huy from Tutoring Club, just confirming your visit with us {relative_day}.

We’ll meet at {meeting_time} to go over {student_names}'s academic plan and next steps.""" + laptop_message + """
You can find us at 79985 Ellis Ave, Fountain Valley, CA 92708.

Looking forward to seeing you soon! Feel free to text back to confirm or if you have any questions."""
        else:
            message_template = f"""
Hi, {guardian_default}. It's Tutoring Club, just confirming your visit with us today.
...
def main():
    ...
    df = Meeting2DataCollectionsVegasOnly.fetch_meeting_data(engine)
    if df.empty:
